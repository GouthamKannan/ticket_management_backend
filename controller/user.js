...
*/
const create = async (user_name, email, password, role, user_type, ver_code) => {
...
* @returns
*/
const send_ver_link = async(user_name, email, password, role, user_type, protocol, host) => {
  ...
  if(sent==true) {
    create(user_name, email, password, role, user_type, ver_code)
    return true
  }
